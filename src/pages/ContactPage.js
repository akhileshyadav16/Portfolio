            ...
            <div className="w-full sm:w-2/3 h-full sm:mx-auto">
                ...
                <form className='flex flex-col gap-10 sm:gap-12 w-11/12 mx-auto h-full py-2 sm:py-10 sm:px-20 pr-2 shadow-[0_0_5px_rgba(100,116,139,0.3)] border-2 border-slate-500 rounded-xl'>
                    <div className='flex gap-2 w-full items-center'>
                        ...
                        <input type="text" placeholder=" Enter first name" name="firstname" id="firstname " className="flex-grow h-12 outline-none w-full bg-slate-500 bg-opacity-20 shadow-[0_0_5px_rgba(100,116,139,0.3)] border border-slate-500 rounded-xl"/>
                    </div>
                    <div className='flex gap-2 w-full items-center'>
