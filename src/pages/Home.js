    ...
    return(
        <div className="text-slate-400 w-screen h-full my-16 pt-20">
            <div className='flex flex-col-reverse sm:flex-col-reverse md:flex-row lg:flex-row  w-4/6 mx-auto md:mb-40 my-2'>
                ...
                <img src='./Aky.png' alt='Aky-pic' className='w-4/5 sm:w-3/5 md:w-1/3  h-4/5 sm:2/5 md:h-1/3 rounded-2xl object-cover shadow-[0_0_10px_rgba(100,116,139,0.5)] border border-slate-500 my-5 mx-auto md:mx-0'/>
            </div>
            <SkillHome/>
